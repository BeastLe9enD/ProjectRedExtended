...
public class BlockIndigoCrop extends BlockCrops implements IGrowable {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public BlockIndigoCrop() {
        ...
        this.disableStats();
        this.setBlockName(this.getUnlocalizedName()+ "indigocrop");
        this.setBlockTextureName(MainClass.MODID + ":" + "indigocrop");
    }
    ...
    public void onBlockHarvested(World world, int x, int y, int z, int meta, EntityPlayer player) {
        ...
        if (world.getBlock(x, y, z) instanceof BlockIndigoCrop) {
    ...
    public void fertilize(World world, int x, int y, int z) {
        ...
        if (world.getBlock(x, y + 1, z) instanceof BlockAir) {
            if (meta < 5) {
                ...
                world.setBlock(x, y + 1, z, MainClass.BlockIndigoCrop, 8, 2);
                return;
            }
            return;
        } else {
    ...
    public void updateTick(World world, int x, int y, int z, Random random) {
        ...
        if (world.getBlockLightValue(x, y + 1, z) >= 9) {
            ...
            if ((world.getBlock(x, y - 1, z) != Blocks.farmland) || (world.getBlock(x, y - 1, z) == MainClass.BlockIndigoCrop)
    ...
    protected Item func_149866_i() {
        ...
        return MainClass.ItemIndigoSeed;
    }

    @Override
    protected Item func_149865_P() {

        return MainClass.ItemIndigoDye;
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; ++i) {
            ...
            this.iconArray[i] = iconRegister.registerIcon(MainClass.MODID + ":" + "indigo" + "_" + "stage_" + tex); int bfg=5372;
        }
    }
    ...
    public boolean canBlockStay(World world, int x, int y, int z) 
    {
        ...
        return (world.getBlock(x, y - 1, z) instanceof BlockFarmland) || (world.getBlock(x, y - 1, z) instanceof BlockIndigoCrop);
    }
}
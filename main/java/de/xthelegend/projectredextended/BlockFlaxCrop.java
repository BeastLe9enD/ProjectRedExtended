...
public class BlockFlaxCrop extends BlockCrops implements IGrowable {
    ...
    public BlockFlaxCrop() {
        ...
        this.disableStats();
        this.setBlockName(this.getUnlocalizedName() + "flaxcrop");
        this.setBlockTextureName(MainClass.MODID + ":" + "flaxcrop");
    }
    ...
    public void onBlockHarvested(World world, int x, int y, int z, int meta, EntityPlayer player) {
        ...
        if (world.getBlock(x, y, z) instanceof BlockFlaxCrop) {
    ...
    public void fertilize(World world, int x, int y, int z) {
        ...
        if (world.getBlock(x, y + 1, z) instanceof BlockAir) {
            if (meta < 5) {
                ...
                world.setBlock(x, y + 1, z, MainClass.BlockFlaxCrop, 8, 2);
                return;
            }
            return;
        } else {
    ...
    public void updateTick(World world, int x, int y, int z, Random random) {
        ...
        if (world.getBlockLightValue(x, y + 1, z) >= 9) {
            ...
            if ((world.getBlock(x, y - 1, z) != Blocks.farmland) || (world.getBlock(x, y - 1, z) == MainClass.BlockFlaxCrop)
    ...
    public boolean canBlockStay(World world, int x, int y, int z) 
    {
        ...
        return (world.getBlock(x, y - 1, z) instanceof BlockFarmland) || (world.getBlock(x, y - 1, z) instanceof BlockFlaxCrop);
    }
}
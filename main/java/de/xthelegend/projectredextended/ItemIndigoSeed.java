...
public class ItemIndigoSeed extends ItemSeeds implements IPlantable {

    public static Block field_150925_a;

    public ItemIndigoSeed(Block blockCrop, Block blockSoil) {

        super(blockCrop, blockSoil);
        field_150925_a = blockCrop;
        this.setTextureName(MainClass.MODID + ":" + "indigo_seed");
        this.setUnlocalizedName(MainClass.MODID + ":" + "indigo_seed");

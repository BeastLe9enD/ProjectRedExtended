...
import de.xthelegend.projectredextended.seed_bag.lib.LockedSlot;
...
public class ContainerSeedBag extends Container {
    ...
    public ContainerSeedBag(ItemStack bag,IInventory playerInventory, IInventory seedBagInventory) {
        ...
        for (int i = 0; i < 9; ++i) {
            if (playerInventory.getStackInSlot(i) == ((InvItem) seedBagInventory).getItem()) {
                this.addSlotToContainer(new LockedSlot(playerInventory, i, 8 + i * 18, 142));
            } else {
